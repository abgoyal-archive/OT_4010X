...
MTK_DEFINE_FD := $(filter MTK_FD,$(JRD_PRODUCT_PACKAGES))
MTK_DEFINE_GEMINI_3G := $(filter MTK_GEMINI_3G,$(JRD_PRODUCT_PACKAGES))
...
ifeq ($(MTK_DEFINE_FD), )
	$(hide) perl mediatek/build/tools/optgenfile.pl $(PRJ_MF) no MTK_FD_SUPPORT
	$(hide) perl mediatek/build/tools/optgenfile.pl $(PRJ_MF) no MTK_FD_FORCE_REL_SUPPORT
else
	$(hide) perl mediatek/build/tools/optgenfile.pl $(PRJ_MF) yes MTK_FD_SUPPORT
	$(hide) perl mediatek/build/tools/optgenfile.pl $(PRJ_MF) yes MTK_FD_FORCE_REL_SUPPORT
endif
ifeq ($(MTK_DEFINE_GEMINI_3G), )
	$(hide) perl mediatek/build/tools/teloptgenfile.pl $(PRJ_MF) no MTK_GEMINI_3G_SWITCH GEMINI
else
	$(hide) perl mediatek/build/tools/teloptgenfile.pl $(PRJ_MF) yes MTK_GEMINI_3G_SWITCH GEMINI 
endif

...
.PHONY : new newall remake remakeall clean cleanall \
         ...
         update-api modem-info clean-modem perso logo dist
...
JRD_DEVICE    =  device/jrdcom/beetlelite
KERNEL_WD     =  kernel
ANDROID_WD    =  .
ALL_MODULES   =  
...
update-modem: clean-modem custgen check-modem
	$(hide) echo $(SHOWTIME) $@ing...
	$(hide) echo -e \\t\\t\\t\\b\\b\\b\\bLOG: $(S_LOG)$@.log
...
ifneq ($(PROJECT), generic)
	...
	$(hide) perl $(MEM_PARTITION_GENERATOR) \
                     ...
                     MEM_PARTITION_TABLE=$(MEM_PARTITION_TABLE) \
                     PARTITION_HEADER_LOCATION=$(PARTITION_HEADER_LOCATION) \
                     SCATTER_FILE=$(dir $(SCATTER_FILE)) \
                     MTK_NAND_PAGE_SIZE=$(MTK_NAND_PAGE_SIZE) \
                     MTK_EMMC_SUPPORT=$(MTK_EMMC_SUPPORT) \
                     EMMC_CHIP=$(EMMC_CHIP) \
                     BOARDCONFIG_LOCATION=$(BOARDCONFIG_LOCATION) \

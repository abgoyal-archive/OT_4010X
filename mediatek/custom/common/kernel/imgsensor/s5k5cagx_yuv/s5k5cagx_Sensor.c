...
void S5K5CAGX_set_mirror(kal_uint8 image_mirror)
	{
		...
		{
			case IMAGE_NORMAL:
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0003); 	//3 REG_0TC_PCFG_uPrevMirror
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0003); 	// REG_0TC_PCFG_uCaptureMirror
				break;
			case IMAGE_H_MIRROR:
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0002); 	//2 REG_0TC_PCFG_uPrevMirror
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0002); 	// REG_0TC_PCFG_uCaptureMirror
				break;
			case IMAGE_V_MIRROR:
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0001); 	//1 REG_0TC_PCFG_uPrevMirror
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0001); 	// REG_0TC_PCFG_uCaptureMirror
				break;
			case IMAGE_HV_MIRROR:
				S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); 	//0 REG_0TC_PCFG_uPrevMirror
...
void S5K5CAGX_Initialize_Setting(void)
	...
	*/
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0030); //003B//#TVAR_ae_BrAve 091222
// AE mode
...
// Horizon
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x021E); //#TVAR_wbt_pBaseCcms
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF41); //#TVAR_wbt_pBaseCcms
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF7A); //#TVAR_wbt_pBaseCcms
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFE4D); //#TVAR_wbt_pBaseCcms
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x02B3); //#TVAR_wbt_pBaseCcms
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFE4A); //#TVAR_wbt_pBaseCcms
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF98); //#TVAR_wbt_pBaseCcms
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF9A); //#TVAR_wbt_pBaseCcms
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x025A); //#TVAR_wbt_pBaseCcms
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0248); //#TVAR_wbt_pBaseCcms
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0163); //#TVAR_wbt_pBaseCcms
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFD7E); //#TVAR_wbt_pBaseCcms
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0219); //#TVAR_wbt_pBaseCcms
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEEE); //#TVAR_wbt_pBaseCcms
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01CC); //#TVAR_wbt_pBaseCcms
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFE30); //#TVAR_wbt_pBaseCcms
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01AF); //#TVAR_wbt_pBaseCcms
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x016C); //#TVAR_wbt_pBaseCcms
// Inca
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01E6); //#TVAR_wbt_pBaseCcms[18]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF47); //#TVAR_wbt_pBaseCcms[19]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFAC); //#TVAR_wbt_pBaseCcms[20]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFE75); //#TVAR_wbt_pBaseCcms[21]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0260); //#TVAR_wbt_pBaseCcms[22]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFE75); //#TVAR_wbt_pBaseCcms[23]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFB3); //#TVAR_wbt_pBaseCcms[24]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFB3); //#TVAR_wbt_pBaseCcms[25]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0226); //#TVAR_wbt_pBaseCcms[26]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0211); //#TVAR_wbt_pBaseCcms[27]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0148); //#TVAR_wbt_pBaseCcms[28]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFDD0); //#TVAR_wbt_pBaseCcms[29]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01F9); //#TVAR_wbt_pBaseCcms[30]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF27); //#TVAR_wbt_pBaseCcms[31]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01B3); //#TVAR_wbt_pBaseCcms[32]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFE70); //#TVAR_wbt_pBaseCcms[33]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x018B); //#TVAR_wbt_pBaseCcms[34]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0151); //#TVAR_wbt_pBaseCcms[35]
// WW
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0231); //#TVAR_wbt_pBaseCcms[36]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF3B); //#TVAR_wbt_pBaseCcms[37]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFC2); //#TVAR_wbt_pBaseCcms[38]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF29); //#TVAR_wbt_pBaseCcms[39]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x022A); //#TVAR_wbt_pBaseCcms[40]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEEF); //#TVAR_wbt_pBaseCcms[41]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFAB); //#TVAR_wbt_pBaseCcms[42]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFA7); //#TVAR_wbt_pBaseCcms[43]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0234); //#TVAR_wbt_pBaseCcms[44]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x019B); //#TVAR_wbt_pBaseCcms[45]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x012E); //#TVAR_wbt_pBaseCcms[46]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEAB); //#TVAR_wbt_pBaseCcms[47]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01D3); //#TVAR_wbt_pBaseCcms[48]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFED2); //#TVAR_wbt_pBaseCcms[49]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x020E); //#TVAR_wbt_pBaseCcms[50]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEC6); //#TVAR_wbt_pBaseCcms[51]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01B3); //#TVAR_wbt_pBaseCcms[52]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0159); //#TVAR_wbt_pBaseCcms[53]
// CWF
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x020D); //#TVAR_wbt_pBaseCcms[54]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF52); //#TVAR_wbt_pBaseCcms[55]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFCF); //#TVAR_wbt_pBaseCcms[56]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF3C); //#TVAR_wbt_pBaseCcms[57]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0200); //#TVAR_wbt_pBaseCcms[58]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF06); //#TVAR_wbt_pBaseCcms[59]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFBC); //#TVAR_wbt_pBaseCcms[60]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFB8); //#TVAR_wbt_pBaseCcms[61]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0212); //#TVAR_wbt_pBaseCcms[62]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0185); //#TVAR_wbt_pBaseCcms[63]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0120); //#TVAR_wbt_pBaseCcms[64]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFECF); //#TVAR_wbt_pBaseCcms[65]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01C0); //#TVAR_wbt_pBaseCcms[66]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEFC); //#TVAR_wbt_pBaseCcms[67]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01F7); //#TVAR_wbt_pBaseCcms[68]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEEB); //#TVAR_wbt_pBaseCcms[69]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x019D); //#TVAR_wbt_pBaseCcms[66]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x014A); //#TVAR_wbt_pBaseCcms[71]
// D50
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0211); //#TVAR_wbt_pBaseCcms[72]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF99); //#TVAR_wbt_pBaseCcms[73]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFE7); //#TVAR_wbt_pBaseCcms[74]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFE76); //#TVAR_wbt_pBaseCcms[75]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0180); //#TVAR_wbt_pBaseCcms[76]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEAD); //#TVAR_wbt_pBaseCcms[77]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFA2); //#TVAR_wbt_pBaseCcms[78]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFD7); //#TVAR_wbt_pBaseCcms[79]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x020F); //#TVAR_wbt_pBaseCcms[80]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FE); //#TVAR_wbt_pBaseCcms[81]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D6); //#TVAR_wbt_pBaseCcms[82]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEB7); //#TVAR_wbt_pBaseCcms[83]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01B2); //#TVAR_wbt_pBaseCcms[84]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF22); //#TVAR_wbt_pBaseCcms[85]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x016E); //#TVAR_wbt_pBaseCcms[86]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEE2); //#TVAR_wbt_pBaseCcms[87]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0178); //#TVAR_wbt_pBaseCcms[88]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x012C); //#TVAR_wbt_pBaseCcms[89]
// D65
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0211); //#TVAR_wbt_pBaseCcms[90]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF99); //#TVAR_wbt_pBaseCcms[91]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFE7); //#TVAR_wbt_pBaseCcms[92]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFE76); //#TVAR_wbt_pBaseCcms[93]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0180); //#TVAR_wbt_pBaseCcms[94]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEAD); //#TVAR_wbt_pBaseCcms[95]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFA2); //#TVAR_wbt_pBaseCcms[96]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFD7); //#TVAR_wbt_pBaseCcms[97]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x020F); //#TVAR_wbt_pBaseCcms[98]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FE); //#TVAR_wbt_pBaseCcms[99]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00D6); //#TVAR_wbt_pBaseCcms[100]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEB7); //#TVAR_wbt_pBaseCcms[101]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01B2); //#TVAR_wbt_pBaseCcms[102]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFF22); //#TVAR_wbt_pBaseCcms[103]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x016E); //#TVAR_wbt_pBaseCcms[104]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFEE2); //#TVAR_wbt_pBaseCcms[105]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0178); //#TVAR_wbt_pBaseCcms[106]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x012C); //#TVAR_wbt_pBaseCcms[107]
...
// 
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x033E); //awbb_IndoorGrZones_m_BGrid[0] 
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x03CA); //awbb_IndoorGrZones_m_BGrid[1] 
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x02EA); //awbb_IndoorGrZones_m_BGrid[2] 
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x03DA); //awbb_IndoorGrZones_m_BGrid[3] 
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x02D4); //awbb_IndoorGrZones_m_BGrid[4] 
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x03D2); //awbb_IndoorGrZones_m_BGrid[5] 
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x02BC); //awbb_IndoorGrZones_m_BGrid[6] 
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x03BA); //awbb_IndoorGrZones_m_BGrid[7] 
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x02A6); //awbb_IndoorGrZones_m_BGrid[8] 
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0398); //awbb_IndoorGrZones_m_BGrid[9] 
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0298); //awbb_IndoorGrZones_m_BGrid[10]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0368); //awbb_IndoorGrZones_m_BGrid[11]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x027E); //awbb_IndoorGrZones_m_BGrid[12]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x033A); //awbb_IndoorGrZones_m_BGrid[13]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x026C); //awbb_IndoorGrZones_m_BGrid[14]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0306); //awbb_IndoorGrZones_m_BGrid[15]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x025A); //awbb_IndoorGrZones_m_BGrid[16]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x02DE); //awbb_IndoorGrZones_m_BGrid[17]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0246); //awbb_IndoorGrZones_m_BGrid[16]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x02C2); //awbb_IndoorGrZones_m_BGrid[19]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0232); //awbb_IndoorGrZones_m_BGrid[20]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x02A6); //awbb_IndoorGrZones_m_BGrid[21]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x021E); //awbb_IndoorGrZones_m_BGrid[22]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x028E); //awbb_IndoorGrZones_m_BGrid[21]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0208); //awbb_IndoorGrZones_m_BGrid[24]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x027A); //awbb_IndoorGrZones_m_BGrid[25]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01EE); //awbb_IndoorGrZones_m_BGrid[26]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0268); //awbb_IndoorGrZones_m_BGrid[27]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01F0); //awbb_IndoorGrZones_m_BGrid[28]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0128); // #awbb_IndoorGrZones_m_Boffs
...
//	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0040); //#Tune_TP_AvMoveToGamutDist
  ...
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//0000	//awbb_GridCorr_R[0] //        	                                                                        
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//0000	//awbb_GridCorr_R[1] //    
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//0000	//awbb_GridCorr_R[2] //    
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//0000	//awbb_GridCorr_R[3] //    
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//FFF0	//awbb_GridCorr_R[4] //    
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//0080	//awbb_GridCorr_R[5] //               
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0050);//0000	//awbb_GridCorr_R[6] //    
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//0000	//awbb_GridCorr_R[7] //    
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//0000	//awbb_GridCorr_R[8] //    
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//0000	//awbb_GridCorr_R[9] //    
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//FFF0	//awbb_GridCorr_R[10] //   
  S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFE0);//0080	//awbb_GridCorr_R[11] //               
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//0000	//awbb_GridCorr_R[12] //   
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//0000	//awbb_GridCorr_R[13] //   
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//0000	//awbb_GridCorr_R[14] //   
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//0000	//awbb_GridCorr_R[15] //   
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//FFF0	//awbb_GridCorr_R[16] //   
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//0080	//awbb_GridCorr_R[17] //   
  ...
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//0032	//awbb_GridCorr_B[2] //                                                                          
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//0000	//awbb_GridCorr_B[3] //                                                                          
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//0020	//awbb_GridCorr_B[4] //                                                                          
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//FFC0	//awbb_GridCorr_B[5] //           
  S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFB0);//0000	//awbb_GridCorr_B[6] //                                                                          
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//0000	//awbb_GridCorr_B[7] //                                                                          
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0050);//0032	//awbb_GridCorr_B[8] //                                                                          
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0050);//0000	//awbb_GridCorr_B[9] //                                                                          
  S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFE2);//0020	//awbb_GridCorr_B[10] //                                                                         
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0050);//FFC0	//awbb_GridCorr_B[11] //           
  ...
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//0032	//awbb_GridCorr_B[14] //                                                                         
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//0000	//awbb_GridCorr_B[15] //                                                                         
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//0020	//awbb_GridCorr_B[16] //   
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000);//FFC0	//awbb_GridCorr_B[17] //                 
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x02DA);	//awbb_GridConst_1[0] //                                                                     
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0359);	//awbb_GridConst_1[1] //                                                                     
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x03D3);	//awbb_GridConst_1[2] //                                                                     
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0E26);	//0E4F//0DE9//0DE9//awbb_GridConst_2[0] //                                                   
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0E78);	//0EDD//0EDD//0EDD//awbb_GridConst_2[1] //                                                   
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0ECA);	//0F42//0F42//0F42//awbb_GridConst_2[2] //                                                   
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0F06);	//0F4E//0F4E//0F54//awbb_GridConst_2[3] //                                                   
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0F36);	//0F99//0F99//0FAE//awbb_GridConst_2[4] //                                                   
  S5K5CAGX_write_cmos_sensor(0x0F12, 0x0F85);	//1006//1006//1011//awbb_GridConst_2[5] //                                                   
...
// Noise index
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0014); //#TVAR_afit_pBaseVals[0]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[0]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0014); //#TVAR_afit_pBaseVals[2]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C1); //#TVAR_afit_pBaseVals[5]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0251); //#TVAR_afit_pBaseVals[8]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[17]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[18]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01AA); //#TVAR_afit_pBaseVals[19]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003C); //#TVAR_afit_pBaseVals[20]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003C); //#TVAR_afit_pBaseVals[21]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[22]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[23]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003E); //#TVAR_afit_pBaseVals[24]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0008); //#TVAR_afit_pBaseVals[25]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003C); //#TVAR_afit_pBaseVals[26]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001E); //#TVAR_afit_pBaseVals[27]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003C); //#TVAR_afit_pBaseVals[28]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001E); //#TVAR_afit_pBaseVals[29]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x045A); //#TVAR_afit_pBaseVals[38]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x081E); //#TVAR_afit_pBaseVals[42]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A14); //#TVAR_afit_pBaseVals[43]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0F0F); //#TVAR_afit_pBaseVals[44]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A07); //#TVAR_afit_pBaseVals[45]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0032); //#TVAR_afit_pBaseVals[46]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x000E); //#TVAR_afit_pBaseVals[47]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0306); //#TVAR_afit_pBaseVals[55]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x4603); //#TVAR_afit_pBaseVals[56]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0480); //#TVAR_afit_pBaseVals[57]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003C); //#TVAR_afit_pBaseVals[58]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0707); //#TVAR_afit_pBaseVals[61]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x4601); //#TVAR_afit_pBaseVals[62]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x4944); //#TVAR_afit_pBaseVals[63]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x5044); //#TVAR_afit_pBaseVals[64]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0500); //#TVAR_afit_pBaseVals[65]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0003); //#TVAR_afit_pBaseVals[66]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x5400); //#TVAR_afit_pBaseVals[67]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0714); //#TVAR_afit_pBaseVals[68]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x32FF); //#TVAR_afit_pBaseVals[69]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x5A04); //#TVAR_afit_pBaseVals[70]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x201E); //#TVAR_afit_pBaseVals[71]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1403); //#TVAR_afit_pBaseVals[74]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0114); //#TVAR_afit_pBaseVals[75]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101); //#TVAR_afit_pBaseVals[76]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x4446); //#TVAR_afit_pBaseVals[77]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x646E); //#TVAR_afit_pBaseVals[78]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[81]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x141E); //#TVAR_afit_pBaseVals[82]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[85]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1414); //#TVAR_afit_pBaseVals[89]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101); //#TVAR_afit_pBaseVals[90]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x4601); //#TVAR_afit_pBaseVals[91]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x6E44); //#TVAR_afit_pBaseVals[92]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x2864); //#TVAR_afit_pBaseVals[93]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A00); //#TVAR_afit_pBaseVals[94]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0003); //#TVAR_afit_pBaseVals[95]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1E00); //#TVAR_afit_pBaseVals[96]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0714); //#TVAR_afit_pBaseVals[97]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x32FF); //#TVAR_afit_pBaseVals[98]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0004); //#TVAR_afit_pBaseVals[99]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0F00); //#TVAR_afit_pBaseVals[100]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0014); //#TVAR_afit_pBaseVals[106]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C1); //#TVAR_afit_pBaseVals[109]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0251); //#TVAR_afit_pBaseVals[112]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[121]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[122]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01AE); //#TVAR_afit_pBaseVals[123]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[126]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[127]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003E); //#TVAR_afit_pBaseVals[128]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0008); //#TVAR_afit_pBaseVals[129]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003C); //#TVAR_afit_pBaseVals[124]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001E); //#TVAR_afit_pBaseVals[131]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003C); //#TVAR_afit_pBaseVals[125]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001E); //#TVAR_afit_pBaseVals[133]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x045A); //#TVAR_afit_pBaseVals[142]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x081E); //#TVAR_afit_pBaseVals[146]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A14); //#TVAR_afit_pBaseVals[147]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0F0F); //#TVAR_afit_pBaseVals[148]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A07); //#TVAR_afit_pBaseVals[149]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0032); //#TVAR_afit_pBaseVals[150]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x000E); //#TVAR_afit_pBaseVals[151]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0306); //#TVAR_afit_pBaseVals[159]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x4603); //#TVAR_afit_pBaseVals[160]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0480); //#TVAR_afit_pBaseVals[161]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0046); //#TVAR_afit_pBaseVals[162]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0080); //#TVAR_afit_pBaseVals[163]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101); //#TVAR_afit_pBaseVals[164]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0707); //#TVAR_afit_pBaseVals[165]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1E01); //#TVAR_afit_pBaseVals[166]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x491E); //#TVAR_afit_pBaseVals[167]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x5044); //#TVAR_afit_pBaseVals[168]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0500); //#TVAR_afit_pBaseVals[169]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0004); //#TVAR_afit_pBaseVals[170]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x3C0A); //#TVAR_afit_pBaseVals[171]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0714); //#TVAR_afit_pBaseVals[172]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x3214); //#TVAR_afit_pBaseVals[173]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x5A03); //#TVAR_afit_pBaseVals[174]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x121E); //#TVAR_afit_pBaseVals[175]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x4012); //#TVAR_afit_pBaseVals[176]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0604); //#TVAR_afit_pBaseVals[177]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1E06); //#TVAR_afit_pBaseVals[178]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x3A3C); //#TVAR_afit_pBaseVals[181]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x585A); //#TVAR_afit_pBaseVals[182]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[185]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x141E); //#TVAR_afit_pBaseVals[186]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[189]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x3C01); //#TVAR_afit_pBaseVals[195]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x5A3A); //#TVAR_afit_pBaseVals[196]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x2858); //#TVAR_afit_pBaseVals[197]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A00); //#TVAR_afit_pBaseVals[198]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0003); //#TVAR_afit_pBaseVals[199]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1E00); //#TVAR_afit_pBaseVals[200]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0714); //#TVAR_afit_pBaseVals[201]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x32FF); //#TVAR_afit_pBaseVals[202]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0004); //#TVAR_afit_pBaseVals[203]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0F00); //#TVAR_afit_pBaseVals[204]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C1); //#TVAR_afit_pBaseVals[213]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0251); //#TVAR_afit_pBaseVals[216]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[225]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[226]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0226); //#TVAR_afit_pBaseVals[227]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[230]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[231]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004E); //#TVAR_afit_pBaseVals[232]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[233]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003C); //#TVAR_afit_pBaseVals[234]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001E); //#TVAR_afit_pBaseVals[235]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003C); //#TVAR_afit_pBaseVals[236]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x001E); //#TVAR_afit_pBaseVals[237]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0906); //#TVAR_afit_pBaseVals[244]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FF); //#TVAR_afit_pBaseVals[245]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x045A); //#TVAR_afit_pBaseVals[246]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x081E); //#TVAR_afit_pBaseVals[250]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A14); //#TVAR_afit_pBaseVals[251]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0F0F); //#TVAR_afit_pBaseVals[252]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A07); //#TVAR_afit_pBaseVals[253]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0090); //#TVAR_afit_pBaseVals[254]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x000A); //#TVAR_afit_pBaseVals[255]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0306); //#TVAR_afit_pBaseVals[263]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x4602); //#TVAR_afit_pBaseVals[264]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0880); //#TVAR_afit_pBaseVals[265]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101); //#TVAR_afit_pBaseVals[268]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0707); //#TVAR_afit_pBaseVals[269]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1E01); //#TVAR_afit_pBaseVals[270]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x3C1E); //#TVAR_afit_pBaseVals[271]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x5028); //#TVAR_afit_pBaseVals[272]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0500); //#TVAR_afit_pBaseVals[273]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1A04); //#TVAR_afit_pBaseVals[274]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x280A); //#TVAR_afit_pBaseVals[275]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x080C); //#TVAR_afit_pBaseVals[276]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1414); //#TVAR_afit_pBaseVals[277]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x6A03); //#TVAR_afit_pBaseVals[278]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x121E); //#TVAR_afit_pBaseVals[279]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x4012); //#TVAR_afit_pBaseVals[280]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0604); //#TVAR_afit_pBaseVals[281]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x2806); //#TVAR_afit_pBaseVals[282]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0128); //#TVAR_afit_pBaseVals[283]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101); //#TVAR_afit_pBaseVals[284]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x2224); //#TVAR_afit_pBaseVals[285]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x3236); //#TVAR_afit_pBaseVals[286]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0410); //#TVAR_afit_pBaseVals[289]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x141E); //#TVAR_afit_pBaseVals[290]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x2828); //#TVAR_afit_pBaseVals[297]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101); //#TVAR_afit_pBaseVals[298]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x2401); //#TVAR_afit_pBaseVals[299]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x3622); //#TVAR_afit_pBaseVals[300]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x2832); //#TVAR_afit_pBaseVals[301]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A00); //#TVAR_afit_pBaseVals[302]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1003); //#TVAR_afit_pBaseVals[303]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1E04); //#TVAR_afit_pBaseVals[304]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0714); //#TVAR_afit_pBaseVals[305]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0032); //#TVAR_afit_pBaseVals[313]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C1); //#TVAR_afit_pBaseVals[317]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0251); //#TVAR_afit_pBaseVals[320]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0050); //#TVAR_afit_pBaseVals[327]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0226); //#TVAR_afit_pBaseVals[331]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[334]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[335]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x004E); //#TVAR_afit_pBaseVals[336]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[337]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x002D); //#TVAR_afit_pBaseVals[338]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0019); //#TVAR_afit_pBaseVals[339]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x002D); //#TVAR_afit_pBaseVals[340]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0019); //#TVAR_afit_pBaseVals[341]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0906); //#TVAR_afit_pBaseVals[348]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FF); //#TVAR_afit_pBaseVals[349]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x045A); //#TVAR_afit_pBaseVals[350]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x081E); //#TVAR_afit_pBaseVals[354]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A14); //#TVAR_afit_pBaseVals[355]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0F0F); //#TVAR_afit_pBaseVals[356]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A07); //#TVAR_afit_pBaseVals[357]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0090); //#TVAR_afit_pBaseVals[358]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x000A); //#TVAR_afit_pBaseVals[359]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0001); //#TVAR_afit_pBaseVals[360]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0307); //#TVAR_afit_pBaseVals[367]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x5002); //#TVAR_afit_pBaseVals[368]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101); //#TVAR_afit_pBaseVals[372]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0707); //#TVAR_afit_pBaseVals[373]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1E01); //#TVAR_afit_pBaseVals[374]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x2A1E); //#TVAR_afit_pBaseVals[375]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x5020); //#TVAR_afit_pBaseVals[376]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0500); //#TVAR_afit_pBaseVals[377]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1A04); //#TVAR_afit_pBaseVals[378]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x280A); //#TVAR_afit_pBaseVals[379]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x080C); //#TVAR_afit_pBaseVals[380]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1414); //#TVAR_afit_pBaseVals[381]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x6A03); //#TVAR_afit_pBaseVals[382]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x121E); //#TVAR_afit_pBaseVals[383]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x4012); //#TVAR_afit_pBaseVals[384]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0604); //#TVAR_afit_pBaseVals[385]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x3C06); //#TVAR_afit_pBaseVals[386]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1C1E); //#TVAR_afit_pBaseVals[389]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1E22); //#TVAR_afit_pBaseVals[390]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0214); //#TVAR_afit_pBaseVals[393]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0E14); //#TVAR_afit_pBaseVals[394]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x4052); //#TVAR_afit_pBaseVals[397]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x150C); //#TVAR_afit_pBaseVals[398]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1E01); //#TVAR_afit_pBaseVals[403]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x221C); //#TVAR_afit_pBaseVals[404]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x281E); //#TVAR_afit_pBaseVals[405]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1402); //#TVAR_afit_pBaseVals[408]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x060E); //#TVAR_afit_pBaseVals[409]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x32FF); //#TVAR_afit_pBaseVals[410]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x5204); //#TVAR_afit_pBaseVals[411]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0C40); //#TVAR_afit_pBaseVals[412]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0032); //#TVAR_afit_pBaseVals[417]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00C1); //#TVAR_afit_pBaseVals[421]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0251); //#TVAR_afit_pBaseVals[424]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0032); //#TVAR_afit_pBaseVals[428]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x028A); //#TVAR_afit_pBaseVals[429]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0032); //#TVAR_afit_pBaseVals[430]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x01F4); //#TVAR_afit_pBaseVals[431]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x003C); //#TVAR_afit_pBaseVals[436]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0050); //#TVAR_afit_pBaseVals[437]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[438]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[439]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0044); //#TVAR_afit_pBaseVals[440]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0014); //#TVAR_afit_pBaseVals[441]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0046); //#TVAR_afit_pBaseVals[442]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0019); //#TVAR_afit_pBaseVals[443]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0046); //#TVAR_afit_pBaseVals[444]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0019); //#TVAR_afit_pBaseVals[445]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0503); //#TVAR_afit_pBaseVals[449]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x080F); //#TVAR_afit_pBaseVals[450]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0808); //#TVAR_afit_pBaseVals[451]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0000); //#TVAR_afit_pBaseVals[452]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x00FF); //#TVAR_afit_pBaseVals[453]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x012D); //#TVAR_afit_pBaseVals[454]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x061E); //#TVAR_afit_pBaseVals[458]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A1E); //#TVAR_afit_pBaseVals[459]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0606); //#TVAR_afit_pBaseVals[460]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A08); //#TVAR_afit_pBaseVals[461]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x378B); //#TVAR_afit_pBaseVals[462]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1028); //#TVAR_afit_pBaseVals[463]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0001); //#TVAR_afit_pBaseVals[464]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0307); //#TVAR_afit_pBaseVals[471]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x5001); //#TVAR_afit_pBaseVals[472]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0E0E); //#TVAR_afit_pBaseVals[476]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101); //#TVAR_afit_pBaseVals[477]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x3201); //#TVAR_afit_pBaseVals[478]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1832); //#TVAR_afit_pBaseVals[479]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x210C); //#TVAR_afit_pBaseVals[480]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A00); //#TVAR_afit_pBaseVals[481]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1E04); //#TVAR_afit_pBaseVals[482]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A08); //#TVAR_afit_pBaseVals[483]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x070C); //#TVAR_afit_pBaseVals[484]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x3264); //#TVAR_afit_pBaseVals[485]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x5A02); //#TVAR_afit_pBaseVals[486]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1040); //#TVAR_afit_pBaseVals[487]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x4012); //#TVAR_afit_pBaseVals[488]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0604); //#TVAR_afit_pBaseVals[489]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x4606); //#TVAR_afit_pBaseVals[490]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0146); //#TVAR_afit_pBaseVals[491]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0101); //#TVAR_afit_pBaseVals[492]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1C18); //#TVAR_afit_pBaseVals[493]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1819); //#TVAR_afit_pBaseVals[494]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0514); //#TVAR_afit_pBaseVals[497]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0C14); //#TVAR_afit_pBaseVals[498]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x4646); //#TVAR_afit_pBaseVals[505]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x191C); //#TVAR_afit_pBaseVals[508]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x2818); //#TVAR_afit_pBaseVals[509]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0A00); //#TVAR_afit_pBaseVals[510]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1403); //#TVAR_afit_pBaseVals[511]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x1405); //#TVAR_afit_pBaseVals[512]
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x050C); //#TVAR_afit_pBaseVals[513]
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0042); //#REG_0TC_PCFG_PVIMask //s0050 = FALSE in MSM6290 : s0052 = TRUE in MSM6800 //reg 027A
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0x0042);  //#REG_0TC_CCFG_PVIMask 
	...
	S5K5CAGX_write_cmos_sensor(0x0F12, 0xFFF8);	

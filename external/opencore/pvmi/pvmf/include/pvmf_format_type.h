...
#define PVMF_MIME_YUV420_PLANAR_MTKYUV      "X-YUV-420-PLANAR-MTKYUV"
...
#define PVMF_MIME_ADPCM			"audio/ADPCM" // HP Cheng for ADPCM
...
class PVMFFormatType
{
    public:
        ...
        //return true if a media type is network source.
        OSCL_IMPORT_REF bool isNetworkSource() const;

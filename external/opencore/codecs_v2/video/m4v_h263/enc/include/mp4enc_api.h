...
#ifdef MT6516_MP4_HW_ENCODER
    OSCL_IMPORT_REF Bool	PVGetVolHeaderHW(VideoEncControls *encCtrl, UChar *volHeader, Int *size, Int layer);
#endif
...
#ifdef MT6516_MP4_HW_ENCODER
    OSCL_IMPORT_REF Bool	PVEncodeVideoFrameHW(VideoEncControls *encCtrl, VideoEncFrameIO *vid_in, VideoEncFrameIO *vid_out,
                                            ULong *nextModTime, UChar *bstream, Int *size, Int *nLayer, Bool *IsKeyFrm);
#endif
...
#ifdef MT6516_MP4_HW_ENCODER
    OSCL_IMPORT_REF Bool	PVCleanUpVideoEncoderHW(VideoEncControls *encCtrl);
#endif

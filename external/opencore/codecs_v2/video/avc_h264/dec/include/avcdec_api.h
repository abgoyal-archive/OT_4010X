...
#define H264_MAX_FRAME_HEIGHT   1080
...
extern "C"
{
    ...
    */
    ...
    /**
    This function sniffs the nal_unit_type such that users can call corresponding APIs.
    \param "bitstream"  "Pointer to the beginning of a slice header."
    \param "size"       "size of the bitstream (NumBytesInNALunit + 1)."
    \param "slicetype" "Pointer to the return value of slice type."
    \return "AVCDEC_SUCCESS if success, AVCDEC_FAIL otherwise."
    */
OSCL_EXPORT_REF AVCDec_Status PVAVCDecGetSliceType(uint8 *bitstream, int size, uint *slicetype);

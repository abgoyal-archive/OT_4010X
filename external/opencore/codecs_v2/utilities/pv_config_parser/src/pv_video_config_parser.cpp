...
// <--- Morris Yang 20110128 remove first 11 bytes
// --->
        // BITMAPINFOHEADER
...
// <--- Morris Yang 20110128 remove first 11 bytes
                ...
                pData += (40); //sizeof(BITMAPINFOHEADER); // position to sequence header
// --->
	...
	{
		aOutputs->width  = (uint32)720;
        aOutputs->height = (uint32)480;
		return 0;
	}
	// HungChih Lin (end)
    else

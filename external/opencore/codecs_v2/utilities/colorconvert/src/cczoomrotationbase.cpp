...
ColorConvertBase::ColorConvertBase(): _mRowPix(NULL), _mColPix(NULL), _mInitialized(false), _mState(0), _mYuvRange(false)
    , _mCrop_width(0)
    , _mCrop_height(0)
    , mPixelFormat(PIXEL_FORMAT_YUV_420_PLANER)
{
}
...
OSCL_EXPORT_REF void ColorConvertBase::SetInputBufFormat(PixelFormat aPixelFormat)
{
...
OSCL_EXPORT_REF void ColorConvertBase::SetCropSize(uint32 aCropWidth, uint32 aCropHeight)
{
    _mCrop_width = aCropWidth;
    _mCrop_height = aCropHeight;
}

OSCL_EXPORT_REF void ColorConvertBase::SetPmemSrcBufVA(uint32 aPmemSrcBufVA)
{
    _mPmemSrcBufVA = aPmemSrcBufVA;
}

OSCL_EXPORT_REF void ColorConvertBase::SetPmemDstBufPA(uint32 aPmemDstBufPA)
{
    _mPmemDstBufPA = aPmemDstBufPA;
}

...
OMX_ERRORTYPE RvRegister()
{
    ...
    if (pCRT)
    {
        ...
        pCRT->FunctionPtrCreateComponent = &OmxComponentFactoryDynamicCreate;
        pCRT->FunctionPtrDestroyComponent = &OmxComponentFactoryDynamicDestructor;
        pCRT->SharedLibraryName = (OMX_STRING)"libomx_rvdec_sharedlibrary.so";
        pCRT->SharedLibraryPtr = NULL;

        OsclUuid *temp = (OsclUuid *) oscl_malloc(sizeof(OsclUuid));
        if (temp == NULL)
        {
        	LOGE ("RvRegister return OMX_ErrorInsufficientResources");
            oscl_free(pCRT); // free allocated memory
            return OMX_ErrorInsufficientResources;
        }
    ...
    {
    	LOGE ("RvRegister return OMX_ErrorInsufficientResources B");
        return OMX_ErrorInsufficientResources;
    }
...
extern OMX_ERRORTYPE RaOmxComponentFactory(OMX_OUT OMX_HANDLETYPE* pHandle, OMX_IN  OMX_PTR pAppData, OMX_PTR pProxy, OMX_STRING aOmxLibName, OMX_PTR &aOmxLib, OMX_PTR aOsclUuid, OMX_U32 &aRefCount);
...
OMX_ERRORTYPE RaRegister()
{
    ...
    if (pCRT)
    {
        ...
        pCRT->FunctionPtrCreateComponent = &OmxComponentFactoryDynamicCreate;
        pCRT->FunctionPtrDestroyComponent = &OmxComponentFactoryDynamicDestructor;
        pCRT->SharedLibraryName = (OMX_STRING)"libomx_radec_sharedlibrary.so";
        pCRT->SharedLibraryPtr = NULL;
...
//added by HP Cheng
///////////////////////////////////////////////////////////////////////////////////////////////
#if REGISTER_OMX_WAVENC_COMPONENT
// external factory functions needed for creation of each component (or stubs for testing)
#if (DYNAMIC_LOAD_OMX_WAVENC_COMPONENT == 0)
extern OMX_ERRORTYPE WavEncOmxComponentFactory(OMX_OUT OMX_HANDLETYPE* pHandle, OMX_IN  OMX_PTR pAppData, OMX_IN OMX_PTR pProxy, OMX_STRING aOmxLibName, OMX_PTR &aOmxLib, OMX_PTR aOsclUuid, OMX_U32 &aRefCount);
extern OMX_ERRORTYPE WavEncOmxComponentDestructor(OMX_IN OMX_HANDLETYPE pHandle, OMX_PTR &aOmxLib, OMX_PTR aOsclUuid, OMX_U32 &aRefCount);
#endif
#endif
#if (REGISTER_OMX_WAVENC_COMPONENT) || (USE_DYNAMIC_LOAD_OMX_COMPONENTS)
/////////////////////////////////////////////////////////////////////////////
OMX_ERRORTYPE WavEncRegister()
{
    ComponentRegistrationType* pCRT = (ComponentRegistrationType*) oscl_malloc(sizeof(ComponentRegistrationType));

    //LOGD("hphp: WavEncRegister()");

    if (pCRT)
    {
        pCRT->ComponentName = (OMX_STRING)"OMX.PV.wavenc";
        pCRT->RoleString[0] = (OMX_STRING)"audio_encoder.wav";
        pCRT->NumberOfRolesSupported = 1;
        pCRT->SharedLibraryOsclUuid = NULL;
#if USE_DYNAMIC_LOAD_OMX_COMPONENTS

        //LOGD("hphp: WavEncRegister() uses USE_DYNAMIC_LOAD_OMX_COMPONENTS");
        pCRT->FunctionPtrCreateComponent = &OmxComponentFactoryDynamicCreate;
        pCRT->FunctionPtrDestroyComponent = &OmxComponentFactoryDynamicDestructor;
        pCRT->SharedLibraryName = (OMX_STRING)"libomx_wavenc_sharedlibrary.so";
        pCRT->SharedLibraryPtr = NULL;
        ...
        OSCL_PLACEMENT_NEW(temp, PV_OMX_WAVENC_UUID);
        ...
        pCRT->FunctionPtrCreateComponent = &WavEncOmxComponentFactory;
        pCRT->FunctionPtrDestroyComponent = &WavEncOmxComponentDestructor;
        pCRT->SharedLibraryName = NULL;
        pCRT->SharedLibraryPtr = NULL;

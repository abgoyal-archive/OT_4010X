...
typedef struct ComponentPortType
{
	...
	OMX_AUDIO_PARAM_ADPCMTYPE		AudioAdpcmParam;		//by HP Cheng
    ...
    OMX_AUDIO_PARAM_RATYPE         AudioRaParam;                             // by Morris Yang
...
{
    public:
        virtual bool getTimeStart() {return 0;};
        virtual bool getTimeEnd() {return 0;};
        virtual bool getInputQueueTime(OMX_BUFFERHEADERTYPE *a_prBufHdr) {return 0;};
        virtual bool getInputQueueStartTime(OMX_BUFFERHEADERTYPE *a_prBufHdr) {return 0;};
        virtual bool getInputQueueEndTime(OMX_BUFFERHEADERTYPE *a_prBufHdr) {return 0;};
        virtual bool getInputDeQueueTime(OMX_BUFFERHEADERTYPE *a_prBufHdr) {return 0;};
        virtual bool getOutputQueueTime(OMX_BUFFERHEADERTYPE *a_prBufHdr) {return 0;};
        virtual bool getOutputQueueStartTime(OMX_BUFFERHEADERTYPE *a_prBufHdr) {return 0;};
        virtual bool getOutputQueueEndTime(OMX_BUFFERHEADERTYPE *a_prBufHdr) {return 0;};
        virtual bool getOutputDeQueueTime(OMX_BUFFERHEADERTYPE *a_prBufHdr) {return 0;};
        virtual bool getReturnInputBufferTime(OMX_BUFFERHEADERTYPE *a_prBufHdr){return 0;}  
	virtual OMX_ERRORTYPE FlushPortFinal(OMX_S32 PortIndex) {return OMX_ErrorNone;}

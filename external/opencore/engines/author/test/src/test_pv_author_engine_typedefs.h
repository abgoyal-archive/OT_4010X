...
#define KWavComposerMimeType        "/x-pvmf/ff-mux/wav"		//added by HP Cheng
...
#define KPcmEncMimeType "/x-pvmf/audio/encode/pcm"		//added by HP Cheng
#define KAdpcmEncMimeType "/x-pvmf/audio/encode/adpcm"		//added by HP Cheng
...
typedef enum
{
	...
	PCM16In_PCM16Out_Test = 237,							//.pcm//207
    ...
    UnCompressed_NormalTestEnd = 238,

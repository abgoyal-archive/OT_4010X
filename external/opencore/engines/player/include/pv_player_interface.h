...
class PVPlayerInterface
{
    public:
        ...
        **/
        ...
        // add by Ryan for reset engine when looping
        /**
         * This function may be used for handling reseting the parameter for looping.
         *
         **/
        virtual void ResetEngineForLooping() = 0;

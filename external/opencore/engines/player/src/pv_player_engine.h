...
typedef enum
{
    ...
    PVP_ENGINE_COMMAND_CANCEL_ALL_COMMANDS = 10,
    ...
    PVP_ENGINE_COMMAND_GET_CURRENT_POSITION = 20,
    ...
    PVP_ENGINE_COMMAND_GET_LICENSE_STATUS_OOTSYNC = 40,
    ...
    PVP_ENGINE_COMMAND_ERROR_HANDLING_PREPARE = 50,
...
class PVPlayerEngineDatapath
{
    public:
        ...
        PVPlayerEngineDatapath(const PVPlayerEngineDatapath& aSrc)
        {
            ...
            // Honda add
            iSinkThreadCreated = aSrc.iSinkThreadCreated;
        };
        ...
        // Honda add for SinkThread create
        bool iSinkThreadCreated;
};
        ...
        public ThreadSafeQueueObserver
{
    ...
    private:
        PVPlayerEngine(bool aHwAccelerated, uint32* pUserData);
    ...
    // add by Ryan
    public:
        virtual void ResetEngineForLooping();

    private:
        // add by Ryan for av sync control
        PVMFAVSyncbase mAVSyncCtrl;

        void ClearAllNodesBuffer();
    ...
    // <--- Morris Yang ALPS00133034
        bool iHttpRepositionBeforeStart;
        bool iIsHttpStreaming;
    // --->

    // <--- Morris Yang ALPS00135233
        bool iIgnoreMoovDataReady;
    // --->
};

...
// Ryan Lin !!
#undef LOG_TAG
#define LOG_TAG "PVPlayerDatapath"
...
PVPlayerDatapath::PVPlayerDatapath() :
		...
		iPendingCmds(0)		// added by donghui wang to fix ALPS00122138
{
    bShowLog = Oscl_File_Cfg::LoadCfg(Oscl_File_Cfg::CFG_PLAYER, "log_datapath");

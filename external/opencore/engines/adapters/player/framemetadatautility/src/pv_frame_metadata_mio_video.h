        ...
        public PvmiCapabilityAndConfig
{
    public:
        ...
        PVMFStatus GetFrameProperties(uint32& aFrameWidth, uint32& aFrameHeight, uint32& aDisplayWidth, uint32& aDisplayHeight, uint32& aCropWidth, uint32& aCropHeight, uint32& aPmemSrcBufVA);
        PVMFStatus GetFrameFormatType(PVMFFormatType& aVideoSubFormat);

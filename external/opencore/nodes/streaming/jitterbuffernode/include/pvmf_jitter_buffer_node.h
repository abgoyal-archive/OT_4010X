        ...
        public PVMFMediaClockStateObserver
{
    public:
        ...
        void SetSessionDuration(uint32 duration) { if (ipJitterBufferMisc) ipJitterBufferMisc->SetSessionDuration(duration); }
        void DisableRTCPFeedback() { if (ipJitterBufferMisc) ipJitterBufferMisc->DisableRTCPFeedback(); }
     // <--- Morris Yang ALPS00131435
        virtual void SetAllowRegOldPkt(bool value);
     // --->

     // <--- Morris Yang ALPS00225213, ALPS00225214
	PVFirewallPacketExchangeImpl* GetFireWallPacketExchangerImpl()
	{
	    if (ipJitterBufferMisc) 
	    	return ipJitterBufferMisc->GetFireWallPacketExchangerImpl();
	    else
	    	return NULL;
	}
     // --->
    ...
    private:
        ...
        uint32 iConsective_zero_buffering_count;
        // --->

        // <--- Morris Yang ALPS00135691
        bool iIsBuffering;
        int iLastDelayPercent;
        // --->

...
class PVMFJitterBufferConstructParams
{
    public:
        PVMFJitterBufferConstructParams(PVMFMediaClock& aEstimatedServerClock
                                        ...
                                        , PVMFJitterBufferMisc* _pJBMisc = NULL)
        ...
        PVMFJitterBufferMisc* GetJitterBufferMisc() const
        {
            return pJBMisc;
        }

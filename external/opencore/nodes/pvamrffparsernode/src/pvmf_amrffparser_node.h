...
class PVAMRDurationCalculator : public OsclTimerObject
{
    public:
        PVAMRDurationCalculator(int32 aPriority, CAMRFileParser * aAmrFile, CAMRFileParser ** aaAssistFile,PVMFNodeInterface* aNode, bool aScanEnabled = true);
        ~PVAMRDurationCalculator();
        void Run();
        void ScheduleAO();
    private:
        bool iScanComplete;
        bool iScanEnabled;
        AMRErrorType iErrorCode;
        CAMRFileParser* iAMRFile;
	CAMRFileParser ** iAssistFile;
        ...
        , public PVMFCPMPluginLicenseInterface
{
	...
	PVAMRDurationCalculator *iDurationCalcAO;
	CAMRFileParser  * iAssistAmrFileParser;
	friend class PVAMRDurationCalculator;
        // stream id
        uint32 iStreamID;
        // flaf for bos
        bool iSendBOS;

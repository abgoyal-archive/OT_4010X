...
int32 EmptyBufferDoneThreadSafeCallbackAOEnc::RunError(int32 aError)
{
    PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_STACK_TRACE, (0, "EBuf RunError: %d", aError));
    //return (OsclErrNone);
    return (aError);
}

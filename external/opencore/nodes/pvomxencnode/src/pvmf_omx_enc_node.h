...
#if defined(MHAL_H_INCLUDED) || defined(MT6573_MFV_HW)
#include "mhal_venc_buf.h"  // for VENC_NUMBER_OUTPUT_BUFFER
#endif
...
#if defined(MHAL_H_INCLUDED) || defined(MT6573_MFV_HW)
#define NUMBER_OUTPUT_BUFFER VENC_NUMBER_OUTPUT_BUFFER
#else
...
//  OSCL_IMPORT_REF bool queryInterface(const PVUuid& uuid, PVInterface*& iface);
    ...
    private:
		...
		bool SetADPCMEncoderParameters();			// added by HP Cheng

...
// Morris Yang 20100719 [
        OSCL_IMPORT_REF bool SendConfigBufferToOMXComponent(uint8 *initbuffer, uint32 initbufsize, bool bLastConfigBuf = false);
// ]
    ...
    public:	        
        uint32 getSeqNum(){return iSeqNum;}
    ...
    protected:
        // Ryan Lin !!
        // For Pmem  
        PVMFPmemMemAlloc iOutBufMemoryAlloc;

...
// <--- Morris Yang ALPS00221177 add for m.youtube.com
        OSCL_IMPORT_REF virtual void setCookie(OSCL_String& aCookie);
// --->
...
class pvDownloadControl : public DownloadControlInterface
{
    public:
        ...
        // force to send resume notifcation by client
	  OSCL_IMPORT_REF virtual void forceResumeNotification();

...
OSCL_EXPORT_REF void DownloadContainer::setCookie(OSCL_String& aCookie)
{
    if (!iCfgFileContainer->isEmpty())
    {
        iCfgFileContainer->getCfgFile()->SetCookie(aCookie);
    }
}
// --->
...
OSCL_EXPORT_REF void pvDownloadControl::forceResumeNotification()
{
      //this flag will be executed in checkResumeNotification()
	  iForceResume = true;
}

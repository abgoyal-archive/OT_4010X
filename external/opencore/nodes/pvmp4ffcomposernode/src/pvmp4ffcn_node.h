...
//added isIntraFrame Param. by hai.li @2010-11-04 for alps131643
        PVMFStatus AddMemFragToTrack(Oscl_Vector<OsclMemoryFragment, OsclMemAllocator> aFrame, OsclRefCounterMemFrag& aMemFrag, PVMFFormatType aFormat,
                                     uint32& aTimestamp, int32 aTrackId, uint32 isIntraFrame, PVMp4FFComposerPort *aPort);

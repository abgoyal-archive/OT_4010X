        ...
        public PvmiCapabilityAndConfig
{
    public:
		...
		// added by HP Cheng for WAV header
		void SetSamplingRate(int sampleRate) { iSamplingRate = sampleRate; }
		void SetChannelNumber(int chNum) { iChannelNumber = chNum; }
    ...
    private:
		...
		// added by HP Cheng for WAV header
		bool iHasWavHeaderInFile;
		int32 iSamplingRate;
		int32 iChannelNumber;

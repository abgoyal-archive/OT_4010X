...
#ifdef MT6573_MFV_HW
  #define _MAX_VIDEO_DIMENSION_   (864*480)
  #define _MAX_VIDEO_W_H_         (864)
#else
        ...
        public PvmfDataSourceDirectionControlInterface
{
    ...
    private:
        ...
        bool CheckMpeg4AudioObjectType(uint32 aId);
        bool CheckAVCLevelIndex(uint32 aId);
        ...
        void LogMediaDataToFile(PVMFSharedMediaDataPtr data, PVMFPortInterface* aPort);
        uint32 iNumAudioFrame;      
        uint32 iNumVideoFrame; 
        FILE *_medialog_fp;
    ...
    private:
        ...
        bool bPlaybackOverVideoDuration;
        bool bAudioOnlyPresentation;
        uint32 _uDbgFlags;

// <--- Morris Yang ALPS00135233
        bool iWaitingForMoov;
        uint32 iMoovSize;
// --->
};

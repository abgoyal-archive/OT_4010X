...
#define PVAACFF_DURATION_SCAN_AO_DELAY 				1000  // us
#define PVAACFF_DEFAULT_NUM_OF_FRAMES         		5

class PVAACDurationCalculator : public OsclTimerObject
{
    public:
        PVAACDurationCalculator(int32 aPriority, CAACFileParser* aAACFileParser, PVMFNodeInterface* aNode, bool aScanEnabled = true);
        ~PVAACDurationCalculator();
        void Run();
        void ScheduleAO();
    private:
		int32 iErrorCode;
        ...
        , public PVMFCPMPluginLicenseInterface
{
    public:
		...
		void ReportDurationInfoMsg(uint32 aDurationMs);
...
////////////////////////////////////////////////////////////////////////////////////
    ...
    private:  // private data members
		...
		PVAACDurationCalculator *iDurationCalcAO;
		friend class PVAACDurationCalculator;
		// <---sam sun for aac seek table gen

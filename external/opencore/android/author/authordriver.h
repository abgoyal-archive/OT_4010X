...
#define ANDROID_MAX_ENCODED_FRAME_WIDTH            720
...
static const int32 MAX_VIDEO_BITRATE_SETTING = 3400000;
...
,public CameraInputMIONotify //modify by zhongmingliang @2010-09-14(ISSUE:alps00121109)
{
public:

    virtual void _CameraInputMIOCallback(void* p);//modify by zhongmingliang @2010-09-14(ISSUE:alps00121109)
    ...
    void handleFinalStop(author_command *ac); //modify by zhongmingliang @2010-09-14(ISSUE:alps00121109)

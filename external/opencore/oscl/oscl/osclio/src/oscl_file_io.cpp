...
#include <utils/Log.h>
#undef LOG_TAG
#define LOG_TAG "Oscl_File"
#if 0
#undef PVLOGGER_LOGMSG
#define PVLOGGER_LOGMSG(IL, LOGGER, LEVEL, MESSAGE) MSG MESSAGE
...
//if cache is not enabled, then cleanup any old implementation.
{
    ...
    if (asyncEnable == true)
    {
        LOGD("***** async read Enable: %s *****", asyncEnable?"true":"false");
    }
...
OSCL_EXPORT_REF int32 Oscl_File::Open(const oscl_wchar *filename, uint32 mode, Oscl_FileServer& fileserv)
{
    if (iLogger)
    {
        ...
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG,
                        (0, "Oscl_File(0x%x)::Open IN name '%s' mode %d serv 0x%x", (uint32)this, str.get_cstr(), mode, (uint32)&fileserv));
    }
...
ErrorExit:
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG,
                        (0, "Oscl_File(0x%x)::Open OUT result %d", (uint32)this, result));
    }
...
OSCL_EXPORT_REF int32 Oscl_File::Open(const char *filename, uint32 mode, Oscl_FileServer& fileserv)
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG,
                        (0, "Oscl_File(0x%x)::Open IN name '%s' mode %d serv 0x%x", (uint32)this, filename, mode, (uint32)&fileserv));
    }
...
OSCL_EXPORT_REF int32 Oscl_File::Close()
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG,
                        (0, "Oscl_File(0x%x)::Close IN", (uint32)this));
    }
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG,
                        (0, "Oscl_File(0x%x)::Close OUT result %d", (uint32)this, result));
    }
...
OSCL_EXPORT_REF uint32 Oscl_File::Read(OsclAny *buffer, uint32 size, uint32 numelements)
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG,
                        (0, "Oscl_File(0x%x)::Read IN size %d num %d", (uint32)this, size, numelements));
    }
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG,
                        (0, "Oscl_File(0x%x)::Read OUT result %d", (uint32)this, result));
    }
    return result;
}
...
OSCL_EXPORT_REF uint32 Oscl_File::Write(const OsclAny *buffer, uint32 size, uint32 numelements)
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG,
                        (0, "Oscl_File(0x%x)::Write IN size %d num %d", (uint32)this, size, numelements));
    }
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG,
                        (0, "Oscl_File(0x%x)::Write OUT result %d", (uint32)this, result));
    }
    return result;
}
...
OSCL_EXPORT_REF int32 Oscl_File::Seek(TOsclFileOffset offset, seek_type origin)
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG,
                        (0, "Oscl_File(0x%x)::Seek IN offset %d origin %d", (uint32)this, (int32)offset, origin));
    }
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG,
                        (0, "Oscl_File(0x%x)::Seek OUT result %d", (uint32)this, result));
    }
    return result;
}
...
OSCL_EXPORT_REF TOsclFileOffset Oscl_File::Tell()
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG,
                        (0, "Oscl_File(0x%x)::Tell IN", (uint32)this));
    }
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG,
                        (0, "Oscl_File(0x%x)::Tell OUT result %d", (uint32)this, (int32)result));
    }
    return result;
}
...
OSCL_EXPORT_REF int32 Oscl_File::Flush()
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG,
                        (0, "Oscl_File(0x%x)::Flush IN", (uint32)this));
    }
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG,
                        (0, "Oscl_File(0x%x)::Flush OUT result %d", (uint32)this, result));
    }
    return result;
}
...
OSCL_EXPORT_REF int32 Oscl_File::EndOfFile()
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG,
                        (0, "Oscl_File(0x%x)::EndOfFile IN", (uint32)this));
    }
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG,
                        (0, "Oscl_File(0x%x)::EndOfFile OUT result %d", (uint32)this, result));
    }
    return result;
}
...
OSCL_EXPORT_REF TOsclFileOffset Oscl_File::Size()
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iLogger, PVLOGMSG_DEBUG,
                        (0, "Oscl_File(0x%x)::Size OUT result %d", (uint32)this, (int32)result));
    }
    return result;
}
                                 ...
                                 , Oscl_FileServer& fileserv)
{
    if (iNativeLogger)
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iNativeLogger, PVLOGMSG_DEBUG,
                        (0, "OsclNativeFile(0x%x)::Open IN handle 0x%x mode %d serv 0x%x", (uint32)this, (uint32)&handle, mode, (uint32)&fileserv));
    }
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iNativeLogger, PVLOGMSG_DEBUG,
                        (0, "OsclNativeFile(0x%x)::Open OUT result %d", (uint32)this, result));
    }
                                 ...
                                 , Oscl_FileServer& fileserv)
{
    ...
    if (iNativeLogger)
    {
        ...
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iNativeLogger, PVLOGMSG_DEBUG,
                        (0, "OsclNativeFile(0x%x)::Open IN name '%s' mode %d serv 0x%x", (uint32)this, str.get_cstr(), mode, (uint32)&fileserv));
    }
                                 ...
                                 , Oscl_FileServer& fileserv)
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iNativeLogger, PVLOGMSG_DEBUG,
                        (0, "OsclNativeFile(0x%x)::Open IN name '%s' mode %d serv 0x%x", (uint32)this, filename, mode, (uint32)&fileserv));
    }
...
uint32 Oscl_File::CallNativeRead(OsclAny *buffer, uint32 size, uint32 numelements)
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iNativeLogger, PVLOGMSG_DEBUG,
                        (0, "OsclNativeFile(0x%x)::Read IN size %d numelements %d", (uint32)this, size, numelements));
    }
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iNativeLogger, PVLOGMSG_DEBUG,
                        (0, "OsclNativeFile(0x%x)::Read OUT result %d", (uint32)this, result));
    }
...
uint32 Oscl_File::CallNativeWrite(const OsclAny *buffer, uint32 size, uint32 numelements)
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iNativeLogger, PVLOGMSG_DEBUG,
                        (0, "OsclNativeFile(0x%x)::Write IN size %d numelements %d", (uint32)this, size, numelements));
    }
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iNativeLogger, PVLOGMSG_DEBUG,
                        (0, "OsclNativeFile(0x%x)::Write OUT result %d", (uint32)this, result));
    }
...
int32  Oscl_File::CallNativeSeek(TOsclFileOffset offset, Oscl_File::seek_type origin)
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iNativeLogger, PVLOGMSG_DEBUG,
                        (0, "OsclNativeFile(0x%x)::Seek IN offset %d origin %d", (uint32)this, (int32)offset, origin));
    }
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iNativeLogger, PVLOGMSG_DEBUG,
                        (0, "OsclNativeFile(0x%x)::Seek OUT result %d", (uint32)this, result));
    }
...
TOsclFileOffset  Oscl_File::CallNativeTell()
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iNativeLogger, PVLOGMSG_DEBUG,
                        (0, "OsclNativeFile(0x%x)::Tell IN", (uint32)this));
    }
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iNativeLogger, PVLOGMSG_DEBUG,
                        (0, "OsclNativeFile(0x%x)::Tell OUT result %d", (uint32)this, (int32)result));
    }
...
int32  Oscl_File::CallNativeFlush()
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iNativeLogger, PVLOGMSG_DEBUG,
                        (0, "OsclNativeFile(0x%x)::Flush IN", (uint32)this));
    }
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iNativeLogger, PVLOGMSG_DEBUG,
                        (0, "OsclNativeFile(0x%x)::Flush OUT result %d", (uint32)this, result));
    }
...
int32  Oscl_File::CallNativeEndOfFile()
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iNativeLogger, PVLOGMSG_DEBUG,
                        (0, "OsclNativeFile(0x%x)::EndOfFile IN", (uint32)this));
    }
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iNativeLogger, PVLOGMSG_DEBUG,
                        (0, "OsclNativeFile(0x%x)::EndOfFile OUT result %d", (uint32)this, result));
    }
...
TOsclFileOffset Oscl_File::CallNativeSize()
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iNativeLogger, PVLOGMSG_DEBUG,
                        (0, "OsclNativeFile(0x%x)::Size IN", (uint32)this));
    }
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iNativeLogger, PVLOGMSG_DEBUG,
                        (0, "OsclNativeFile(0x%x)::Size OUT result %d", (uint32)this, (int32)result));
    }
...
int32 Oscl_File::CallNativeClose()
{
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iNativeLogger, PVLOGMSG_DEBUG,
                        (0, "OsclNativeFile(0x%x)::Close IN", (uint32)this));
    }
    ...
    {
        PVLOGGER_LOGMSG(PVLOGMSG_INST_LLDBG, iNativeLogger, PVLOGMSG_DEBUG,
                        (0, "OsclNativeFile(0x%x)::Close OUT result %d", (uint32)this, result));
    }

    ...
    public:
        ...
        */
        ...
        OSCL_IMPORT_REF static IMpeg4File *readMP4File(OSCL_wString& aFilename,
                ...
                Oscl_FileServer* aFileServSession = NULL, bool bUseAsyncRead = true);

// <--- Morris Yang ALPS00135233
        OSCL_IMPORT_REF static IMpeg4File *readMP4FileWithHeaderOffset(OSCL_wString& aFilename,
                PVMFCPMPluginAccessInterfaceFactory* aCPMAccessFactory,
                OsclFileHandle* aHandle = NULL,
                uint32 aParsingMode = 0,
                uint32 aHeaderOffset = 0,
                Oscl_FileServer* aFileServSession = NULL, bool bUseAsyncRead = true);
// --->

...
class MP4_FF_FILE
{
    public:
        ...
        PVFile                _pvfile;
         ...
         bool bEnableAsyncRead;
         void EnableAsyncRead(bool bEnable) { bEnableAsyncRead = bEnable; }
         bool UseAsyncRead() { return bEnableAsyncRead; }
};
...
class AtomUtils
{
    ...
    public:
        ...
        OSCL_IMPORT_REF static int32  OpenMP4File(OSCL_wString& filename, uint32 mode, MP4_FF_FILE *fp, int32 iAsyncReadCacheSize = 0);
